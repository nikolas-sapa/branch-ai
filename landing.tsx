...
const MONO = "'Geist Mono', 'Fira Code', 'Cascadia Code', monospace";
...
export default function BranchAILanding() {
  return (
    <div
      className="min-h-screen bg-[#0B0B0D] text-[#E8E8EC] antialiased"
      style={{ fontFamily: SANS, fontSize: '16px', lineHeight: '1.6' }}
    >
      <style jsx global>{`
      ...
      >
        ...
        <ul className="flex gap-7 list-none m-0 p-0">
          {[['#problem', 'problem'], ['#features', 'features'], ['#install', 'install'], ['https://github.com', 'github ↗']].map(
            ([href, label]) => (
              <li key={href}>
                <a
                  href={href}
                  style={{ fontFamily: MONO }}
                  className="text-[12px] text-[#8A8A96] hover:text-[#E8E8EC] no-underline transition-colors tracking-[0.03em]"
                >
                  {label}
                </a>
              </li>
      ...
      <section
        id="hero"
        className="min-h-[90vh] flex items-center py-24"
      ...
      >
        <div className="max-w-[900px] mx-auto px-8 w-full">
          ...
          <h1
            style={{ fontFamily: MONO, fontSize: 'clamp(28px, 4vw, 44px)' }}
            className="font-semibold leading-[1.15] tracking-[-0.03em] text-[#E8E8EC] mb-6 max-w-[700px]"
          >
            Fork the AI&apos;s thinking.<br />
            <span className="text-[#E55A1C]">Not just the output.</span>
          </h1>
          <p className="text-[17px] text-[#8A8A96] leading-[1.65] max-w-[580px] mb-11">
            Branch captures every reasoning step as a navigable tree. Rewind to any point. Explore
            alternative paths. Inject new facts mid-thought. Works with{' '}
            <strong className="text-[#E8E8EC] font-medium">Claude Code</strong>,{' '}
            <strong className="text-[#E8E8EC] font-medium">Codex</strong>,{' '}
            <strong className="text-[#E8E8EC] font-medium">Gemini CLI</strong>, and{' '}
            <strong className="text-[#E8E8EC] font-medium">Factory Droid</strong>.
          </p>
          <div className="flex items-center gap-5 flex-wrap mb-[72px]">
            ...
            <a
              href="#demo"
              style={{ fontFamily: MONO }}
              className="flex items-center gap-1.5 text-[14px] text-[#8A8A96] hover:text-[#E8E8EC] no-underline transition-colors tracking-[-0.01em]"
            >
              View demo <span className="text-[#E55A1C]">→</span>
            </a>
          </div>

          {/* Reasoning tree */}
          <div className="relative bg-[#1A1A1E] border border-[#2A2A2E] rounded-[12px] px-8 py-7 max-w-[560px] overflow-hidden">
            <div
      ...
      {/* THE PROBLEM */}
      <section id="problem" className="py-[100px]" style={{ borderBottom: '1px solid #1F1F23' }}>
        <div className="max-w-[900px] mx-auto px-8">
          ...
          <p className="text-[19px] text-[#8A8A96] leading-[1.7] max-w-[640px] border-l-2 border-[#2A2A2E] pl-6 m-0">
            When an AI works through a hard problem,{' '}
            <strong className="text-[#E8E8EC] font-medium">
              the reasoning vanishes the moment you see the answer.
            </strong>{' '}
            You got a wall of text you can&apos;t interact with, can&apos;t trace, and can&apos;t learn from.
            If the answer is wrong, you start over. If it&apos;s right,{' '}
            <strong className="text-[#E8E8EC] font-medium">you don&apos;t know why.</strong>
          </p>
        </div>
      </section>

      {/* FEATURES */}
      <section id="features" className="py-[100px]" style={{ borderBottom: '1px solid #1F1F23' }}>
        <div className="max-w-[900px] mx-auto px-8">
          <p style={{ fontFamily: MONO }} className="text-[11px] text-[#E55A1C] tracking-[0.12em] uppercase mb-5">
            // 02 · what you get
          </p>
            ...
            {FEATURES.map((f) => (
              ...
              >
                <div
                  ...
                  style={{ background: 'rgba(229,90,28,0.12)' }}
                />
                ...
                <div
                  style={{ fontFamily: MONO }}
                  className="text-[18px] font-semibold text-[#E55A1C] mb-3 tracking-[-0.02em]"
                >
                  {f.name}
                </div>
                <p className="text-[14px] text-[#8A8A96] leading-[1.6] m-0">{f.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* SUPPORTED CLIs */}
      <section id="clis" className="py-[100px]" style={{ borderBottom: '1px solid #1F1F23' }}>
        <div className="max-w-[900px] mx-auto px-8">
          <p style={{ fontFamily: MONO }} className="text-[11px] text-[#E55A1C] tracking-[0.12em] uppercase mb-5">
            // 03 · supported CLIs
          </p>
          <h2
            style={{ fontFamily: MONO, fontSize: 'clamp(22px, 3vw, 32px)' }}
            className="font-semibold leading-[1.2] tracking-[-0.025em] text-[#E8E8EC]"
          >
          ...
          <div className="flex flex-wrap gap-3 my-9">
            {CLI_CHIPS.map((cli) => (
              <div
                key={cli}
                style={{ fontFamily: MONO }}
                className="text-[13px] text-[#8A8A96] bg-[#1A1A1E] border border-[#2A2A2E] rounded-[6px] px-4 py-2 tracking-[-0.01em]"
              >
                {cli}
              </div>
            ))}
          ...
          <p style={{ fontFamily: MONO }} className="text-[13px] text-[#4A4A56]">
            Branch uses your existing CLI auth.{' '}
            <span className="text-[#E55A1C]">No API keys needed.</span>
          </p>
        </div>
      </section>

      {/* THREE WAYS */}
      <section id="usage" className="py-[100px]" style={{ borderBottom: '1px solid #1F1F23' }}>
        <div className="max-w-[900px] mx-auto px-8">
          <p style={{ fontFamily: MONO }} className="text-[11px] text-[#E55A1C] tracking-[0.12em] uppercase mb-5">
            // 04 · three ways to use it
          </p>
          <h2
            style={{ fontFamily: MONO, fontSize: 'clamp(22px, 3vw, 32px)' }}
            className="font-semibold leading-[1.2] tracking-[-0.025em] text-[#E8E8EC] mb-10"
          >
            Terminal. Agent. Team.
          </h2>
              ...
              <div
                ...
                className={`flex items-start gap-5 bg-[#1A1A1E] border border-[#2A2A2E] px-6 py-5 hover:bg-[#141416] transition-colors ${
                  i === 0
                    ? 'rounded-t-[6px]'
                    : i === WAYS.length - 1
                    ? 'rounded-b-[6px] border-t-0'
                    : 'border-t-0'
                }`}
              >
                <span
                  style={{ fontFamily: MONO, background: 'rgba(229,90,28,0.12)', border: '1px solid rgba(229,90,28,0.2)' }}
                  className="text-[11px] text-[#E55A1C] rounded px-2.5 py-0.5 whitespace-nowrap flex-shrink-0 mt-0.5 tracking-[0.04em] uppercase"
                >
                  {way.tag}
                </span>
                <div className="flex-1">
                  ...
                  <p className="text-[13px] text-[#8A8A96] m-0">{way.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* INSTALL */}
      <section id="install" className="py-[100px]" style={{ borderBottom: '1px solid #1F1F23' }}>
        <div className="max-w-[900px] mx-auto px-8">
          <p style={{ fontFamily: MONO }} className="text-[11px] text-[#E55A1C] tracking-[0.12em] uppercase mb-5">
            // 05 · install
          </p>
          ...
          <ul className="flex gap-6 list-none m-0 p-0">
            <li>
              <a
                ...
                target="_blank"
                style={{ fontFamily: MONO }}
                className="text-[12px] text-[#4A4A56] hover:text-[#E8E8EC] no-underline transition-colors tracking-[0.02em]"
              >
                GitHub ↗
              </a>
            </li>
